...
public class FlutterBy {
    ...
    private static class BySemanticsLabel extends FlutterLocator {
        ...
        BySemanticsLabel(String label) {
            super(
                    ...
                    Require.argument("label", label)
                            .nonNull("Cannot find elements when the semantics label is null."));
    ...
    public abstract static class FlutterLocator extends By implements By.Remotable {
